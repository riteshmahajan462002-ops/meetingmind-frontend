          ...
          {PROCESSING_STEPS.map((step, i) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[15px] transition-colors duration-400 ${
                  isCurrent || isDone ? "font-semibold" : "font-normal"
                } ${
                  isDone
                    ? "text-[#10d9a0]"
                    : isCurrent
                ...
                {isDone && (
                  <span className="ml-auto text-[12px] text-[#10d9a0] font-semibold">
                    Done
                  </span>
                )}
              </div>
