              ...
              <div className="mb-5 pb-5 border-b border-[var(--border-card)] flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[13px] text-[var(--text-muted)]">{(data.actionItems || data.action_items || []).length} tasks identified</div>
                  </div>
                </div>
              </div>
              {(data.actionItems || data.action_items || []).length === 0 ? (
                <p className="text-[14px] text-[var(--text-muted)] italic">No action items were identified for this conversation.</p>
              ) : (
